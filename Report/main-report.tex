...
\usepackage{vntex} % Sử dụng tiếng việt
...
\def \TITLE{Báo cáo Đồ án lập trình}
\def \AUTHOR{Nguyễn Duy Cường}
...
\chapter{TÌM HIỂU VỀ NGÔN NGỮ LẬP TRÌNH PYTHON}
\subfile{chapters/Chuong1-tìm_hieu_python}

\chapter{THUẬT TOÁN TÌM ĐƯỜNG ĐI NGẮN NHẤT}
\subfile{chapters/Chuong2-shortest_path}

\chapter{THUẬT TOÁN CÂY QUYẾT ĐỊNH}
\subfile{chapters/Chuong3-decision_tree}
